...
ATetrisGangCharacter::ATetrisGangCharacter()
{
...
void ATetrisGangCharacter::BeginPlay()
{
  // Call the base class  
  Super::BeginPlay();
...
void ATetrisGangCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
  ...
  if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
  {
    ...
    // Moving
    EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATetrisGangCharacter::Move);
...
void ATetrisGangCharacter::Move(const FInputActionValue& Value)
{
  // input is a Vector2D
...
void ATetrisGangCharacter::Look(const FInputActionValue& Value)
{
  // input is a Vector2D
